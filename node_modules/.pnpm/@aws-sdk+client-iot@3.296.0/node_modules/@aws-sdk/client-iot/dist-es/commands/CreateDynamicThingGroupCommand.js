...
import { CreateDynamicThingGroupRequestFilterSensitiveLog, CreateDynamicThingGroupResponseFilterSensitiveLog, } from "../models/models_0";
...
export class CreateDynamicThingGroupCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateDynamicThingGroupCommand.getEndpointParameterInstructions()));
