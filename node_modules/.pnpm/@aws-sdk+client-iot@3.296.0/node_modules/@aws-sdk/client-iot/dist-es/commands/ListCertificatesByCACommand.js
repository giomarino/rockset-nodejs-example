...
import { ListCertificatesByCARequestFilterSensitiveLog, ListCertificatesByCAResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListCertificatesByCACommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListCertificatesByCACommand.getEndpointParameterInstructions()));
