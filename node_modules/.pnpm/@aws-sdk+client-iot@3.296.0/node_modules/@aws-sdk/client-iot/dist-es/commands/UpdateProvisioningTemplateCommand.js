...
import { UpdateProvisioningTemplateRequestFilterSensitiveLog, UpdateProvisioningTemplateResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateProvisioningTemplateCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateProvisioningTemplateCommand.getEndpointParameterInstructions()));
