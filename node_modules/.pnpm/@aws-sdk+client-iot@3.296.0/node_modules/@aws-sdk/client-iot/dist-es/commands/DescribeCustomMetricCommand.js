...
import { DescribeCustomMetricRequestFilterSensitiveLog, DescribeCustomMetricResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DescribeCustomMetricCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeCustomMetricCommand.getEndpointParameterInstructions()));
