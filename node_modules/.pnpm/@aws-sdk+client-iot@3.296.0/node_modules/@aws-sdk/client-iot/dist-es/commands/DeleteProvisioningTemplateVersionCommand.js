...
import { DeleteProvisioningTemplateVersionRequestFilterSensitiveLog, DeleteProvisioningTemplateVersionResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DeleteProvisioningTemplateVersionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteProvisioningTemplateVersionCommand.getEndpointParameterInstructions()));
