...
import { ListThingRegistrationTasksRequestFilterSensitiveLog, ListThingRegistrationTasksResponseFilterSensitiveLog, } from "../models/models_2";
...
export class ListThingRegistrationTasksCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListThingRegistrationTasksCommand.getEndpointParameterInstructions()));
