...
import { DescribeScheduledAuditRequestFilterSensitiveLog, DescribeScheduledAuditResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DescribeScheduledAuditCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeScheduledAuditCommand.getEndpointParameterInstructions()));
