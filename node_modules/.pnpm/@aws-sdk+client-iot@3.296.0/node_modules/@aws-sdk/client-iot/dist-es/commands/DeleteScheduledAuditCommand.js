...
import { DeleteScheduledAuditRequestFilterSensitiveLog, DeleteScheduledAuditResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DeleteScheduledAuditCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteScheduledAuditCommand.getEndpointParameterInstructions()));
