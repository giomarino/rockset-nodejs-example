...
import { SetDefaultAuthorizerRequestFilterSensitiveLog, SetDefaultAuthorizerResponseFilterSensitiveLog, } from "../models/models_2";
...
export class SetDefaultAuthorizerCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, SetDefaultAuthorizerCommand.getEndpointParameterInstructions()));
