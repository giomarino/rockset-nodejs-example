...
import { DetachThingPrincipalRequestFilterSensitiveLog, DetachThingPrincipalResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DetachThingPrincipalCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DetachThingPrincipalCommand.getEndpointParameterInstructions()));
