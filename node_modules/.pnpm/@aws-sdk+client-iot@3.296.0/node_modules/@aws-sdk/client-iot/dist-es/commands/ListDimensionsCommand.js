...
import { ListDimensionsRequestFilterSensitiveLog, ListDimensionsResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListDimensionsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListDimensionsCommand.getEndpointParameterInstructions()));
