...
import { ListAttachedPoliciesRequestFilterSensitiveLog, ListAttachedPoliciesResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListAttachedPoliciesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListAttachedPoliciesCommand.getEndpointParameterInstructions()));
