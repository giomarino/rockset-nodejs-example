...
import { CreateRoleAliasRequestFilterSensitiveLog, CreateRoleAliasResponseFilterSensitiveLog, } from "../models/models_0";
...
export class CreateRoleAliasCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateRoleAliasCommand.getEndpointParameterInstructions()));
