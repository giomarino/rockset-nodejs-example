...
import { UpdateRoleAliasRequestFilterSensitiveLog, UpdateRoleAliasResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateRoleAliasCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateRoleAliasCommand.getEndpointParameterInstructions()));
