...
import { AddThingToBillingGroupRequestFilterSensitiveLog, AddThingToBillingGroupResponseFilterSensitiveLog, } from "../models/models_0";
...
export class AddThingToBillingGroupCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, AddThingToBillingGroupCommand.getEndpointParameterInstructions()));
