...
import { PutVerificationStateOnViolationRequestFilterSensitiveLog, PutVerificationStateOnViolationResponseFilterSensitiveLog, } from "../models/models_2";
import { deserializeAws_restJson1PutVerificationStateOnViolationCommand, serializeAws_restJson1PutVerificationStateOnViolationCommand, } from "../protocols/Aws_restJson1";
export class PutVerificationStateOnViolationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutVerificationStateOnViolationCommand.getEndpointParameterInstructions()));
