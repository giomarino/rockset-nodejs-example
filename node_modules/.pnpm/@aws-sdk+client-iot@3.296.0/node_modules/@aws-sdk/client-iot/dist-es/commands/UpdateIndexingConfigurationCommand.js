...
import { UpdateIndexingConfigurationRequestFilterSensitiveLog, UpdateIndexingConfigurationResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateIndexingConfigurationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateIndexingConfigurationCommand.getEndpointParameterInstructions()));
