...
import { StartDetectMitigationActionsTaskRequestFilterSensitiveLog, StartDetectMitigationActionsTaskResponseFilterSensitiveLog, } from "../models/models_2";
...
export class StartDetectMitigationActionsTaskCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, StartDetectMitigationActionsTaskCommand.getEndpointParameterInstructions()));
