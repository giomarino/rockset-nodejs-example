...
import { DescribeProvisioningTemplateRequestFilterSensitiveLog, DescribeProvisioningTemplateResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DescribeProvisioningTemplateCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeProvisioningTemplateCommand.getEndpointParameterInstructions()));
