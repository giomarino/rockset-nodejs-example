...
import { ListPolicyPrincipalsRequestFilterSensitiveLog, ListPolicyPrincipalsResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListPolicyPrincipalsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListPolicyPrincipalsCommand.getEndpointParameterInstructions()));
