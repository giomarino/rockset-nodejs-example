...
import { UpdateMitigationActionRequestFilterSensitiveLog, UpdateMitigationActionResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateMitigationActionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateMitigationActionCommand.getEndpointParameterInstructions()));
