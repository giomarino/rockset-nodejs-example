...
import { CreateCertificateFromCsrRequestFilterSensitiveLog, CreateCertificateFromCsrResponseFilterSensitiveLog, } from "../models/models_0";
...
export class CreateCertificateFromCsrCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateCertificateFromCsrCommand.getEndpointParameterInstructions()));
