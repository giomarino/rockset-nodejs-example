...
import { ListCustomMetricsRequestFilterSensitiveLog, ListCustomMetricsResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListCustomMetricsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListCustomMetricsCommand.getEndpointParameterInstructions()));
