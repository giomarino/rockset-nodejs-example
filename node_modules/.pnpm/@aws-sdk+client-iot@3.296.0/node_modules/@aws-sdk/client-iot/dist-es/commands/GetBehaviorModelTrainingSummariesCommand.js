...
import { GetBehaviorModelTrainingSummariesRequestFilterSensitiveLog, GetBehaviorModelTrainingSummariesResponseFilterSensitiveLog, } from "../models/models_1";
...
export class GetBehaviorModelTrainingSummariesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetBehaviorModelTrainingSummariesCommand.getEndpointParameterInstructions()));
