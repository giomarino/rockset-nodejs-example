...
import { UpdateDynamicThingGroupRequestFilterSensitiveLog, UpdateDynamicThingGroupResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateDynamicThingGroupCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateDynamicThingGroupCommand.getEndpointParameterInstructions()));
