...
import { StopThingRegistrationTaskRequestFilterSensitiveLog, StopThingRegistrationTaskResponseFilterSensitiveLog, } from "../models/models_2";
...
export class StopThingRegistrationTaskCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, StopThingRegistrationTaskCommand.getEndpointParameterInstructions()));
