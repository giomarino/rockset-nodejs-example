...
import { ListAuditSuppressionsRequestFilterSensitiveLog, ListAuditSuppressionsResponseFilterSensitiveLog, } from "../models/models_1";
import { deserializeAws_restJson1ListAuditSuppressionsCommand, serializeAws_restJson1ListAuditSuppressionsCommand, } from "../protocols/Aws_restJson1";
export class ListAuditSuppressionsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListAuditSuppressionsCommand.getEndpointParameterInstructions()));
