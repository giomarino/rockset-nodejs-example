...
import { DescribeCACertificateRequestFilterSensitiveLog, DescribeCACertificateResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DescribeCACertificateCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeCACertificateCommand.getEndpointParameterInstructions()));
