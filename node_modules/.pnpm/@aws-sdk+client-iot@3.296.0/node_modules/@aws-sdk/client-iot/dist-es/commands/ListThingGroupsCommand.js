...
import { ListThingGroupsRequestFilterSensitiveLog, ListThingGroupsResponseFilterSensitiveLog, } from "../models/models_2";
...
export class ListThingGroupsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListThingGroupsCommand.getEndpointParameterInstructions()));
