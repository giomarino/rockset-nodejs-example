...
import { AddThingToThingGroupRequestFilterSensitiveLog, AddThingToThingGroupResponseFilterSensitiveLog, } from "../models/models_0";
...
export class AddThingToThingGroupCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, AddThingToThingGroupCommand.getEndpointParameterInstructions()));
