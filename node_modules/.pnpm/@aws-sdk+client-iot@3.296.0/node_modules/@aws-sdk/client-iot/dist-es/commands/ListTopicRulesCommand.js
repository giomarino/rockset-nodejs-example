...
import { ListTopicRulesRequestFilterSensitiveLog, ListTopicRulesResponseFilterSensitiveLog, } from "../models/models_2";
...
export class ListTopicRulesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListTopicRulesCommand.getEndpointParameterInstructions()));
