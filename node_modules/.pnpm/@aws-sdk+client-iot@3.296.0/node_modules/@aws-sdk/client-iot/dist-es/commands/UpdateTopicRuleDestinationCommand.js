...
import { UpdateTopicRuleDestinationRequestFilterSensitiveLog, UpdateTopicRuleDestinationResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateTopicRuleDestinationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateTopicRuleDestinationCommand.getEndpointParameterInstructions()));
