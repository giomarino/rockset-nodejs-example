...
import { CreateProvisioningClaimRequestFilterSensitiveLog, CreateProvisioningClaimResponseFilterSensitiveLog, } from "../models/models_0";
...
export class CreateProvisioningClaimCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateProvisioningClaimCommand.getEndpointParameterInstructions()));
