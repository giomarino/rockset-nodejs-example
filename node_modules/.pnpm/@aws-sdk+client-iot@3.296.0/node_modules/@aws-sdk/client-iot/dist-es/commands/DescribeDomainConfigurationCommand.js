...
import { DescribeDomainConfigurationRequestFilterSensitiveLog, DescribeDomainConfigurationResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DescribeDomainConfigurationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeDomainConfigurationCommand.getEndpointParameterInstructions()));
