...
import { GetEffectivePoliciesRequestFilterSensitiveLog, GetEffectivePoliciesResponseFilterSensitiveLog, } from "../models/models_1";
...
export class GetEffectivePoliciesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetEffectivePoliciesCommand.getEndpointParameterInstructions()));
