...
import { EnableTopicRuleRequestFilterSensitiveLog } from "../models/models_1";
...
export class EnableTopicRuleCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, EnableTopicRuleCommand.getEndpointParameterInstructions()));
