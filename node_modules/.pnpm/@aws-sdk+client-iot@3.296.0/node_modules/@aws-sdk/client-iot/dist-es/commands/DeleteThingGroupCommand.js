...
import { DeleteThingGroupRequestFilterSensitiveLog, DeleteThingGroupResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DeleteThingGroupCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteThingGroupCommand.getEndpointParameterInstructions()));
