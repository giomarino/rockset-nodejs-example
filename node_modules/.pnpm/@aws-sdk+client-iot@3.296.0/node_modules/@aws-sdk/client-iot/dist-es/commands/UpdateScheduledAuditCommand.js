...
import { UpdateScheduledAuditRequestFilterSensitiveLog, UpdateScheduledAuditResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateScheduledAuditCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateScheduledAuditCommand.getEndpointParameterInstructions()));
