...
import { CreateProvisioningTemplateVersionRequestFilterSensitiveLog, CreateProvisioningTemplateVersionResponseFilterSensitiveLog, } from "../models/models_0";
...
export class CreateProvisioningTemplateVersionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateProvisioningTemplateVersionCommand.getEndpointParameterInstructions()));
