...
import { StartAuditMitigationActionsTaskRequestFilterSensitiveLog, StartAuditMitigationActionsTaskResponseFilterSensitiveLog, } from "../models/models_2";
...
export class StartAuditMitigationActionsTaskCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, StartAuditMitigationActionsTaskCommand.getEndpointParameterInstructions()));
