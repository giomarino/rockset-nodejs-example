...
import { DescribeThingRegistrationTaskRequestFilterSensitiveLog, DescribeThingRegistrationTaskResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DescribeThingRegistrationTaskCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeThingRegistrationTaskCommand.getEndpointParameterInstructions()));
