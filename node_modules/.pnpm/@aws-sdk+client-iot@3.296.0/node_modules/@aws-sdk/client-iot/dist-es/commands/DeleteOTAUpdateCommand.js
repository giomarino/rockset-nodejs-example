...
import { DeleteOTAUpdateRequestFilterSensitiveLog, DeleteOTAUpdateResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DeleteOTAUpdateCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteOTAUpdateCommand.getEndpointParameterInstructions()));
