...
import { DeleteProvisioningTemplateRequestFilterSensitiveLog, DeleteProvisioningTemplateResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DeleteProvisioningTemplateCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteProvisioningTemplateCommand.getEndpointParameterInstructions()));
