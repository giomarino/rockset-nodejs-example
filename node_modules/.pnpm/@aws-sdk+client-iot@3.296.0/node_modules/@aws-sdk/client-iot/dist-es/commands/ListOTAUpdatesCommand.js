...
import { ListOTAUpdatesRequestFilterSensitiveLog, ListOTAUpdatesResponseFilterSensitiveLog, } from "../models/models_1";
import { deserializeAws_restJson1ListOTAUpdatesCommand, serializeAws_restJson1ListOTAUpdatesCommand, } from "../protocols/Aws_restJson1";
export class ListOTAUpdatesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListOTAUpdatesCommand.getEndpointParameterInstructions()));
