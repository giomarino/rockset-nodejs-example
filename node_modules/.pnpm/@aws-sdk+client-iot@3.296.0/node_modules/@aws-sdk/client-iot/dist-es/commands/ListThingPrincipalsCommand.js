...
import { ListThingPrincipalsRequestFilterSensitiveLog, ListThingPrincipalsResponseFilterSensitiveLog, } from "../models/models_2";
...
export class ListThingPrincipalsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListThingPrincipalsCommand.getEndpointParameterInstructions()));
