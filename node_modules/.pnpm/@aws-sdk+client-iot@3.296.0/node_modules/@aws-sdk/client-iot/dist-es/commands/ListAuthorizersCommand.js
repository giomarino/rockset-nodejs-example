...
import { ListAuthorizersRequestFilterSensitiveLog, ListAuthorizersResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListAuthorizersCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListAuthorizersCommand.getEndpointParameterInstructions()));
