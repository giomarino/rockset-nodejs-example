...
import { GetRegistrationCodeRequestFilterSensitiveLog, GetRegistrationCodeResponseFilterSensitiveLog, } from "../models/models_1";
...
export class GetRegistrationCodeCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetRegistrationCodeCommand.getEndpointParameterInstructions()));
