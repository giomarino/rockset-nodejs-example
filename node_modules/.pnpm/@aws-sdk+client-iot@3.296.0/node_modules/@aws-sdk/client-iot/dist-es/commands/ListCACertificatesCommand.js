...
import { ListCACertificatesRequestFilterSensitiveLog, ListCACertificatesResponseFilterSensitiveLog, } from "../models/models_1";
import { deserializeAws_restJson1ListCACertificatesCommand, serializeAws_restJson1ListCACertificatesCommand, } from "../protocols/Aws_restJson1";
export class ListCACertificatesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListCACertificatesCommand.getEndpointParameterInstructions()));
