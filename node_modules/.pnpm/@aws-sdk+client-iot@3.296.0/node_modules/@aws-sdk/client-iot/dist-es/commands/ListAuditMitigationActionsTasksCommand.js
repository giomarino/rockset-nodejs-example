...
import { ListAuditMitigationActionsTasksRequestFilterSensitiveLog, ListAuditMitigationActionsTasksResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListAuditMitigationActionsTasksCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListAuditMitigationActionsTasksCommand.getEndpointParameterInstructions()));
