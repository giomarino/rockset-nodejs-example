...
import { DescribeRoleAliasRequestFilterSensitiveLog, DescribeRoleAliasResponseFilterSensitiveLog, } from "../models/models_1";
import { deserializeAws_restJson1DescribeRoleAliasCommand, serializeAws_restJson1DescribeRoleAliasCommand, } from "../protocols/Aws_restJson1";
export class DescribeRoleAliasCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeRoleAliasCommand.getEndpointParameterInstructions()));
