...
import { ListScheduledAuditsRequestFilterSensitiveLog, ListScheduledAuditsResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListScheduledAuditsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListScheduledAuditsCommand.getEndpointParameterInstructions()));
