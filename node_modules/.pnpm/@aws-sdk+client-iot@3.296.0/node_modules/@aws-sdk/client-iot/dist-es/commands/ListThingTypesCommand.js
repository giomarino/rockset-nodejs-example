...
import { ListThingTypesRequestFilterSensitiveLog, ListThingTypesResponseFilterSensitiveLog, } from "../models/models_2";
import { deserializeAws_restJson1ListThingTypesCommand, serializeAws_restJson1ListThingTypesCommand, } from "../protocols/Aws_restJson1";
export class ListThingTypesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListThingTypesCommand.getEndpointParameterInstructions()));
