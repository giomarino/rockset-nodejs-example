...
import { UpdateSecurityProfileRequestFilterSensitiveLog, UpdateSecurityProfileResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateSecurityProfileCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateSecurityProfileCommand.getEndpointParameterInstructions()));
