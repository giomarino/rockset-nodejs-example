...
import { GetJobDocumentRequestFilterSensitiveLog, GetJobDocumentResponseFilterSensitiveLog, } from "../models/models_1";
import { deserializeAws_restJson1GetJobDocumentCommand, serializeAws_restJson1GetJobDocumentCommand, } from "../protocols/Aws_restJson1";
export class GetJobDocumentCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetJobDocumentCommand.getEndpointParameterInstructions()));
