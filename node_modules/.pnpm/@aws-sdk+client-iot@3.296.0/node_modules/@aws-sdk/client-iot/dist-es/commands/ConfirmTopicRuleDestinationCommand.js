...
import { ConfirmTopicRuleDestinationRequestFilterSensitiveLog, ConfirmTopicRuleDestinationResponseFilterSensitiveLog, } from "../models/models_0";
...
export class ConfirmTopicRuleDestinationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ConfirmTopicRuleDestinationCommand.getEndpointParameterInstructions()));
