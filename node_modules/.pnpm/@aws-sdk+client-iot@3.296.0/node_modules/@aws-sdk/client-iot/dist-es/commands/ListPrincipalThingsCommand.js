...
import { ListPrincipalThingsRequestFilterSensitiveLog, ListPrincipalThingsResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListPrincipalThingsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListPrincipalThingsCommand.getEndpointParameterInstructions()));
