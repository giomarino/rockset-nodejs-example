...
import { DetachPrincipalPolicyRequestFilterSensitiveLog } from "../models/models_1";
...
export class DetachPrincipalPolicyCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DetachPrincipalPolicyCommand.getEndpointParameterInstructions()));
