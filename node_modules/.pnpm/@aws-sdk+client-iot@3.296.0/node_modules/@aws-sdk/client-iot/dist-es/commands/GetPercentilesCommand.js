...
import { GetPercentilesRequestFilterSensitiveLog, GetPercentilesResponseFilterSensitiveLog, } from "../models/models_1";
...
export class GetPercentilesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetPercentilesCommand.getEndpointParameterInstructions()));
