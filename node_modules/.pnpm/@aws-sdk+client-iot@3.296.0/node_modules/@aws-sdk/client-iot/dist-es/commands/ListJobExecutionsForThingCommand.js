...
import { ListJobExecutionsForThingRequestFilterSensitiveLog, ListJobExecutionsForThingResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListJobExecutionsForThingCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListJobExecutionsForThingCommand.getEndpointParameterInstructions()));
