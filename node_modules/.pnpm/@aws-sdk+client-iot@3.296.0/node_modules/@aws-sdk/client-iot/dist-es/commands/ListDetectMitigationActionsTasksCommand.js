...
import { ListDetectMitigationActionsTasksRequestFilterSensitiveLog, ListDetectMitigationActionsTasksResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListDetectMitigationActionsTasksCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListDetectMitigationActionsTasksCommand.getEndpointParameterInstructions()));
