...
import { DeleteV2LoggingLevelRequestFilterSensitiveLog } from "../models/models_1";
...
export class DeleteV2LoggingLevelCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteV2LoggingLevelCommand.getEndpointParameterInstructions()));
