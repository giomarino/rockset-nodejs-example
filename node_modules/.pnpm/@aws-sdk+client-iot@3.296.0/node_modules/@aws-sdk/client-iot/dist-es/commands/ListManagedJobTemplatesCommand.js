...
import { ListManagedJobTemplatesRequestFilterSensitiveLog, ListManagedJobTemplatesResponseFilterSensitiveLog, } from "../models/models_1";
import { deserializeAws_restJson1ListManagedJobTemplatesCommand, serializeAws_restJson1ListManagedJobTemplatesCommand, } from "../protocols/Aws_restJson1";
export class ListManagedJobTemplatesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListManagedJobTemplatesCommand.getEndpointParameterInstructions()));
