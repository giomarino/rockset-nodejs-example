...
import { DeleteCACertificateRequestFilterSensitiveLog, DeleteCACertificateResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DeleteCACertificateCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteCACertificateCommand.getEndpointParameterInstructions()));
