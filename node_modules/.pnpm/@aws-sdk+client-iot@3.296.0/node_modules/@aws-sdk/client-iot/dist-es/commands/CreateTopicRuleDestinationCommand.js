...
import { CreateTopicRuleDestinationRequestFilterSensitiveLog, CreateTopicRuleDestinationResponseFilterSensitiveLog, } from "../models/models_0";
import { deserializeAws_restJson1CreateTopicRuleDestinationCommand, serializeAws_restJson1CreateTopicRuleDestinationCommand, } from "../protocols/Aws_restJson1";
export class CreateTopicRuleDestinationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateTopicRuleDestinationCommand.getEndpointParameterInstructions()));
