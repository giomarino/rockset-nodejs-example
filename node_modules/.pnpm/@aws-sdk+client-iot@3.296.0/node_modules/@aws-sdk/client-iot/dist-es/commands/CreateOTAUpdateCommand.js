...
import { CreateOTAUpdateRequestFilterSensitiveLog, CreateOTAUpdateResponseFilterSensitiveLog, } from "../models/models_0";
...
export class CreateOTAUpdateCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateOTAUpdateCommand.getEndpointParameterInstructions()));
