...
import { ListRoleAliasesRequestFilterSensitiveLog, ListRoleAliasesResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListRoleAliasesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListRoleAliasesCommand.getEndpointParameterInstructions()));
