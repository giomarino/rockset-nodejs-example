...
import { AttachPrincipalPolicyRequestFilterSensitiveLog } from "../models/models_0";
...
export class AttachPrincipalPolicyCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, AttachPrincipalPolicyCommand.getEndpointParameterInstructions()));
