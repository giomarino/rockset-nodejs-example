...
import { CancelAuditMitigationActionsTaskRequestFilterSensitiveLog, CancelAuditMitigationActionsTaskResponseFilterSensitiveLog, } from "../models/models_0";
...
export class CancelAuditMitigationActionsTaskCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CancelAuditMitigationActionsTaskCommand.getEndpointParameterInstructions()));
