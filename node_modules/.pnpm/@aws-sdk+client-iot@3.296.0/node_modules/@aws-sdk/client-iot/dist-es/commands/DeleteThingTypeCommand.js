...
import { DeleteThingTypeRequestFilterSensitiveLog, DeleteThingTypeResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DeleteThingTypeCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteThingTypeCommand.getEndpointParameterInstructions()));
