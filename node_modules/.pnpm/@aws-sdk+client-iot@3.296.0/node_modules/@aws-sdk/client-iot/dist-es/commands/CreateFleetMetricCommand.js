...
import { CreateFleetMetricRequestFilterSensitiveLog, CreateFleetMetricResponseFilterSensitiveLog, } from "../models/models_0";
import { deserializeAws_restJson1CreateFleetMetricCommand, serializeAws_restJson1CreateFleetMetricCommand, } from "../protocols/Aws_restJson1";
export class CreateFleetMetricCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateFleetMetricCommand.getEndpointParameterInstructions()));
