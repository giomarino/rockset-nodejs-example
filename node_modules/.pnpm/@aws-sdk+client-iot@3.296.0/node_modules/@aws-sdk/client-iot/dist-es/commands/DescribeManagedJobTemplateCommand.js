...
import { DescribeManagedJobTemplateRequestFilterSensitiveLog, DescribeManagedJobTemplateResponseFilterSensitiveLog, } from "../models/models_1";
import { deserializeAws_restJson1DescribeManagedJobTemplateCommand, serializeAws_restJson1DescribeManagedJobTemplateCommand, } from "../protocols/Aws_restJson1";
export class DescribeManagedJobTemplateCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeManagedJobTemplateCommand.getEndpointParameterInstructions()));
