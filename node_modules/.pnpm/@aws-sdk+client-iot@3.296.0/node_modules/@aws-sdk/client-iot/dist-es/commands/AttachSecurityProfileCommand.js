...
import { AttachSecurityProfileRequestFilterSensitiveLog, AttachSecurityProfileResponseFilterSensitiveLog, } from "../models/models_0";
...
export class AttachSecurityProfileCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, AttachSecurityProfileCommand.getEndpointParameterInstructions()));
