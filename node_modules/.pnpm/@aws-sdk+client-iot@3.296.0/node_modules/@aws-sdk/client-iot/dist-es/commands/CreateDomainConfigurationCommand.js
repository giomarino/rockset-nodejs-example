...
import { CreateDomainConfigurationRequestFilterSensitiveLog, CreateDomainConfigurationResponseFilterSensitiveLog, } from "../models/models_0";
...
export class CreateDomainConfigurationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateDomainConfigurationCommand.getEndpointParameterInstructions()));
