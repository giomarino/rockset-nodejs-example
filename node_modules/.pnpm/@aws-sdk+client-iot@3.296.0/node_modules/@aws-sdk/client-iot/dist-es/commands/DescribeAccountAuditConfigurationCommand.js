...
import { DescribeAccountAuditConfigurationRequestFilterSensitiveLog, DescribeAccountAuditConfigurationResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DescribeAccountAuditConfigurationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeAccountAuditConfigurationCommand.getEndpointParameterInstructions()));
