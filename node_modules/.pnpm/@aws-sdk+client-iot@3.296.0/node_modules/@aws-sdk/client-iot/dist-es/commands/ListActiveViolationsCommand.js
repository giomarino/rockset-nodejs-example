...
import { ListActiveViolationsRequestFilterSensitiveLog, ListActiveViolationsResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListActiveViolationsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListActiveViolationsCommand.getEndpointParameterInstructions()));
