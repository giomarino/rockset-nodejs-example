...
import { CreateDimensionRequestFilterSensitiveLog, CreateDimensionResponseFilterSensitiveLog, } from "../models/models_0";
...
export class CreateDimensionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateDimensionCommand.getEndpointParameterInstructions()));
