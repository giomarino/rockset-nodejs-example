...
import { UpdateThingGroupRequestFilterSensitiveLog, UpdateThingGroupResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateThingGroupCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateThingGroupCommand.getEndpointParameterInstructions()));
