...
import { StartOnDemandAuditTaskRequestFilterSensitiveLog, StartOnDemandAuditTaskResponseFilterSensitiveLog, } from "../models/models_2";
...
export class StartOnDemandAuditTaskCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, StartOnDemandAuditTaskCommand.getEndpointParameterInstructions()));
