...
import { CreateScheduledAuditRequestFilterSensitiveLog, CreateScheduledAuditResponseFilterSensitiveLog, } from "../models/models_0";
...
export class CreateScheduledAuditCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateScheduledAuditCommand.getEndpointParameterInstructions()));
