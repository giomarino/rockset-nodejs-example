...
import { CreateCustomMetricRequestFilterSensitiveLog, CreateCustomMetricResponseFilterSensitiveLog, } from "../models/models_0";
...
export class CreateCustomMetricCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateCustomMetricCommand.getEndpointParameterInstructions()));
