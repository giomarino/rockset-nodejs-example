...
import { ListThingRegistrationTaskReportsRequestFilterSensitiveLog, ListThingRegistrationTaskReportsResponseFilterSensitiveLog, } from "../models/models_2";
...
export class ListThingRegistrationTaskReportsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListThingRegistrationTaskReportsCommand.getEndpointParameterInstructions()));
