...
import { ListMitigationActionsRequestFilterSensitiveLog, ListMitigationActionsResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListMitigationActionsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListMitigationActionsCommand.getEndpointParameterInstructions()));
