...
import { DescribeFleetMetricRequestFilterSensitiveLog, DescribeFleetMetricResponseFilterSensitiveLog, } from "../models/models_1";
import { deserializeAws_restJson1DescribeFleetMetricCommand, serializeAws_restJson1DescribeFleetMetricCommand, } from "../protocols/Aws_restJson1";
export class DescribeFleetMetricCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeFleetMetricCommand.getEndpointParameterInstructions()));
