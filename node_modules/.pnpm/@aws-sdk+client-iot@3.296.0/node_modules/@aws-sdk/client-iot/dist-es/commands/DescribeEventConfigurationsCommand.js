...
import { DescribeEventConfigurationsRequestFilterSensitiveLog, DescribeEventConfigurationsResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DescribeEventConfigurationsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeEventConfigurationsCommand.getEndpointParameterInstructions()));
