...
import { DeleteTopicRuleDestinationRequestFilterSensitiveLog, DeleteTopicRuleDestinationResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DeleteTopicRuleDestinationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteTopicRuleDestinationCommand.getEndpointParameterInstructions()));
