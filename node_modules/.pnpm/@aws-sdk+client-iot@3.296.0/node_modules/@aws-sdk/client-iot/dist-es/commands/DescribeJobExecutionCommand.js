...
import { DescribeJobExecutionRequestFilterSensitiveLog, DescribeJobExecutionResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DescribeJobExecutionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeJobExecutionCommand.getEndpointParameterInstructions()));
