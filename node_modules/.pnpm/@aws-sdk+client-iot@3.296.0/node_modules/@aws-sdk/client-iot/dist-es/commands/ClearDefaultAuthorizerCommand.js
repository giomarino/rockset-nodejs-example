...
import { ClearDefaultAuthorizerRequestFilterSensitiveLog, ClearDefaultAuthorizerResponseFilterSensitiveLog, } from "../models/models_0";
...
export class ClearDefaultAuthorizerCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ClearDefaultAuthorizerCommand.getEndpointParameterInstructions()));
