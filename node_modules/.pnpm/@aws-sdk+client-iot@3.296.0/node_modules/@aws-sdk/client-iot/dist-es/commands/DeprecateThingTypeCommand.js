...
import { DeprecateThingTypeRequestFilterSensitiveLog, DeprecateThingTypeResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DeprecateThingTypeCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeprecateThingTypeCommand.getEndpointParameterInstructions()));
