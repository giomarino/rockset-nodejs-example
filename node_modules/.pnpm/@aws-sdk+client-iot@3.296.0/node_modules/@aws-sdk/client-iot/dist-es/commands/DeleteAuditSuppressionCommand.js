...
import { DeleteAuditSuppressionRequestFilterSensitiveLog, DeleteAuditSuppressionResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DeleteAuditSuppressionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteAuditSuppressionCommand.getEndpointParameterInstructions()));
