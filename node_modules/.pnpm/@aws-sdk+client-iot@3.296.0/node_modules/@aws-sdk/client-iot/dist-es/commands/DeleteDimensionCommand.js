...
import { DeleteDimensionRequestFilterSensitiveLog, DeleteDimensionResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DeleteDimensionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteDimensionCommand.getEndpointParameterInstructions()));
