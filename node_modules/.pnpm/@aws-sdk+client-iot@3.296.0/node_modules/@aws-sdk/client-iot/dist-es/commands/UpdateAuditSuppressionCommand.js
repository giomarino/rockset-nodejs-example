...
import { UpdateAuditSuppressionRequestFilterSensitiveLog, UpdateAuditSuppressionResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateAuditSuppressionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateAuditSuppressionCommand.getEndpointParameterInstructions()));
