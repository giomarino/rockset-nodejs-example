...
import { TransferCertificateRequestFilterSensitiveLog, TransferCertificateResponseFilterSensitiveLog, } from "../models/models_2";
...
export class TransferCertificateCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, TransferCertificateCommand.getEndpointParameterInstructions()));
