...
import { CreateThingGroupRequestFilterSensitiveLog, CreateThingGroupResponseFilterSensitiveLog, } from "../models/models_0";
...
export class CreateThingGroupCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateThingGroupCommand.getEndpointParameterInstructions()));
