...
import { AssociateTargetsWithJobRequestFilterSensitiveLog, AssociateTargetsWithJobResponseFilterSensitiveLog, } from "../models/models_0";
...
export class AssociateTargetsWithJobCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, AssociateTargetsWithJobCommand.getEndpointParameterInstructions()));
