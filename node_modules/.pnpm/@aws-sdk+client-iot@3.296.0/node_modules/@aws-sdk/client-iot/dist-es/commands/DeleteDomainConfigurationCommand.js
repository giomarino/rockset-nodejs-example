...
import { DeleteDomainConfigurationRequestFilterSensitiveLog, DeleteDomainConfigurationResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DeleteDomainConfigurationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteDomainConfigurationCommand.getEndpointParameterInstructions()));
