...
import { RejectCertificateTransferRequestFilterSensitiveLog, } from "../models/models_2";
...
export class RejectCertificateTransferCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, RejectCertificateTransferCommand.getEndpointParameterInstructions()));
