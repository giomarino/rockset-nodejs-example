...
import { DeleteCustomMetricRequestFilterSensitiveLog, DeleteCustomMetricResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DeleteCustomMetricCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteCustomMetricCommand.getEndpointParameterInstructions()));
