...
import { ListPrincipalPoliciesRequestFilterSensitiveLog, ListPrincipalPoliciesResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ListPrincipalPoliciesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListPrincipalPoliciesCommand.getEndpointParameterInstructions()));
