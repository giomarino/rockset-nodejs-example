...
import { RegisterCertificateRequestFilterSensitiveLog, RegisterCertificateResponseFilterSensitiveLog, } from "../models/models_2";
...
export class RegisterCertificateCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, RegisterCertificateCommand.getEndpointParameterInstructions()));
