...
import { DeleteDynamicThingGroupRequestFilterSensitiveLog, DeleteDynamicThingGroupResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DeleteDynamicThingGroupCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteDynamicThingGroupCommand.getEndpointParameterInstructions()));
