...
class DescribeJobTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, DescribeJobTemplateCommand.getEndpointParameterInstructions()));
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.DescribeJobTemplateRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.DescribeJobTemplateResponseFilterSensitiveLog,
        };
