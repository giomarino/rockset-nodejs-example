...
class CreateBillingGroupCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, CreateBillingGroupCommand.getEndpointParameterInstructions()));
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.CreateBillingGroupRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.CreateBillingGroupResponseFilterSensitiveLog,
        };
