...
class TestInvokeAuthorizerCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, TestInvokeAuthorizerCommand.getEndpointParameterInstructions()));
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_2_1.TestInvokeAuthorizerRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_2_1.TestInvokeAuthorizerResponseFilterSensitiveLog,
        };
