...
class SetDefaultPolicyVersionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_2_1.SetDefaultPolicyVersionRequestFilterSensitiveLog,
    ...
    serialize(input, context) {
        return (0, Aws_restJson1_1.serializeAws_restJson1SetDefaultPolicyVersionCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restJson1_1.deserializeAws_restJson1SetDefaultPolicyVersionCommand)(output, context);
    }
}
